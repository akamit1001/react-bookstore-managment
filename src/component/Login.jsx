...
render() {
    ...
    return (
        <div className="login_screen">
            <EntryCard>
                <h2> Enter Book Store</h2>
                <Form method="post" name="userLoginForm" onSubmit= {this.submitLoginForm} >
                    <InputGroup>
                        {/* <label htmlFor="login-username">Username</label> */}
                        <Input type="username" name="username" id="login-username" placeholder="Username" value={this.state.username} onChange={this.handleChangeUsername}/>
                        <div className="errorMsg">{this.state.errors.username}</div>
                    </InputGroup>
                    <InputGroup>
                        {/* <label htmlFor="login-password">Password</label> */}
                        <Input type="password" name="password" id="login-password" placeholder="Password" value={this.state.password} onChange={this.handleChangePassword}/>
